console.log('Loaded ImageTable.js');
class ImageTable {
	...
	get(index, key) {
		if (key in this.image_column && index < this.getSize()) return this.image_lines[index][this.image_column[key]];
		return -1;
	}
	findIndex(search_obj) {
		...
		if (key in this.image_mapped) return this.image_mapped[key];
